...
const app = createApp({
    ...
    computed: {
        ...
        kanbanPhases() {
            ...
            return APP_SCHEMA.definitions.initiative.properties.iNNitiativePhase.enum || [];
        },
        initiativesByPhase() {
            const grouped = {};
