    ...
    template: `
        <div class="bg-gray-100 rounded-lg p-4 w-80 md:w-96 flex-shrink-0 kanban-column">
            ...
            <div class="space-y-3">
                ...
                <div v-for="init in initiatives" :key="init.initiativeId"
                    ...
                    <p v-if="init.initiativeManagerId && getPersonNameFn" class="text-xs text-gray-600 truncate">
                        <i data-lucide="user-circle" class="w-3 h-3 inline-block mr-1 text-gray-400"></i>{{ getPersonNameFn(init.initiativeManagerId) }}
                    </p>
